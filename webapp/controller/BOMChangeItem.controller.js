    ...
    function (
        ...
        return Controller.extend("zppbomautomation.controller.BOMChangeItem", {
            ...
            _applySortStringSelectionsToRow: function (aSelectedZcomb) {
                ...
                /*
                 * First selected sort string updates the current row.
                 */
                oBaseRow.sortString = this._cleanSortString(aSelectedZcomb[0]);
                ...
                /*
                 * If user selected more than one sort string,
                 * duplicate the row for remaining sort strings.
                 */
                for (var i = 1; i < aSelectedZcomb.length; i++) {
                    ...
                    oNewRow.sortString = this._cleanSortString(aSelectedZcomb[i]);

                    /*
                     * Duplicated rows are always INSERT rows.
                     */
                    ...
                    /*
                     * Important for Change BOM:
                     * New duplicated row should not carry old backend node number.
                     */
    ...
    BusyIndicator.hide();
            ...
            _validateChangeRowsBeforeSave: async function () {
                ...
                for (var i = 0; i < aItems.length; i++) {
                    ...
                    oItem.sortString = this._cleanSortString(oItem.sortString || "");
            ...
            _buildSingleChangeBomPayload: function (oItem) {
                ...
                return {
                    ...
                    BOMItemSorter:
                        this._cleanSortString(oItem.sortString || ""),
            ...
            _fillChangeModeComponentDetails: async function () {
                ...
                for (var i = 0; i < aItems.length; i++) {
                    ...
                    var sExistingSortString = this._cleanSortString(oItem.sortString || "");
            ...
            _normalizeFetchedChangeItems: function (aFetchedItems) {
                return (aFetchedItems || []).map(
                    function (oItem, iIndex) {
                        ...
                        oRow.sortString = this._getBackendSortString(oItem);
            ...
            _getBackendSortString: function (oItem) {
                if (!oItem) {
                    return "";
                }
